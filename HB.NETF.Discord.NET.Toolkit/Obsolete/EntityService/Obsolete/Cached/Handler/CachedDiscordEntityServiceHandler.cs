...
using HB.NETF.Discord.NET.Toolkit.EntityService.Obsolete.Handler;
...
using HB.NETF.Discord.NET.Toolkit.EntityService.Obsolete.Cached.Handler;
using HB.NETF.Discord.NET.Toolkit.EntityService.Obsolete.Cached;
